...
class MkException extends Exception { public $log_level = 'ERROR'; }

class AppException extends MkException { public $log_level = 'INFO'; }
...
class InvalidCsrfTokenException extends MkException { public $log_level = 'WARNING'; }
